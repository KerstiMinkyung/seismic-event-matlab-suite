...
for t = 1:numel(time)
    ...
    fprintf(fid1,'<h2><big>Alaska Volcano Observatory - State of Health Monitoring</big></h2>\n')
    fprintf(fid1,'<h2><big>Analog Network Voltages</big></h2>\n')
    ...
    fprintf(fid1,'- [<a href="Analog-network-voltages-all.html">Everything!</a>]</h3>\n')
    fprintf(fid1,'</div>\n')
    fprintf(fid1,'<hr style="width: 100%; height: 2px;">\n')
