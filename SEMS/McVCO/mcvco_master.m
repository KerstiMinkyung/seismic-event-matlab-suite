...
plot_mcvco_channel(M,'Amplitudes',SN,t_range,tag,dr)
plot_mcvco_network(M,'Amplitudes',SN,t_range,tag,dr)
dr2 = [dr,'\HTML\Network_Amplitudes_Plots\'];
export_fig([dr2,SN,'-',tag],'-png')
pause(.1)
close all

plot_mcvco_channel(M,'Offsets',SN,t_range,tag,dr)
plot_mcvco_network(M,'Offsets',SN,t_range,tag,dr)
dr2 = [dr,'\HTML\Network_Offsets_Plots\'];
export_fig([dr2,SN,'-',tag],'-png')
pause(.1)
close all
