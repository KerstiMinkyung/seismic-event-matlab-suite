...
for t = 1:numel(time)
    for m = 1:numel(metric)
        ...
        fprintf(fid1,'- [<a href="Amplitudes-%s.html">Amplitudes</a>]\n',TT)
        fprintf(fid1,'- [<a href="Offsets-%s.html">Offsets</a>]\n',TT)
        ...
        fprintf(fid1,'<img src="VoltageColorBar.png"; height="600"; width="60"; style="position:fixed; margin-left:600px;">\n')
            case 'Amplitudes'
        fprintf(fid1,'<img src="AmplitudeColorBar.png"; height="600"; width="80"; style="position:fixed; margin-left:600px;">\n')  
            case 'Offsets'
        fprintf(fid1,'<img src="OffsetColorBar.png"; height="600"; width="80"; style="position:fixed; margin-left:600px;">\n')
            case 'Waveforms'
        end
        fprintf(fid1,'</div>\n')
        ...
        for n = 1:numel(subnets)
            ...
            fprintf(fid2,'- [<a href="%s-Amplitudes-%s.html">Amplitudes</a>]\n',SU,TT)
            fprintf(fid2,'- [<a href="%s-Offsets-%s.html">Offsets</a>]\n',SU,TT)
