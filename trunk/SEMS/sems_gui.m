...
%OUTPUTS: none
  ...
  VLP_RaBut= uicontrol('Style','RadioButton','String','VLP','Enable','off','Position',[270,220,50,20],'CallBack', @VLP_RaBut_CallBack);
  VLP_High_Edit = uicontrol('Style','Edit','BackgroundColor','w','String','10','Enable','off','Position',[315,220,30,20],'CallBack',@VLP_High_Edit_CallBack);
  VLP_Low_Edit = uicontrol('Style','Edit','BackgroundColor','w','String','100','Enable','off','Position',[350,220,30,20],'CallBack',@VLP_Low_Edit_CallBack);
  ...
  EDP_Text = uicontrol('Style','Text','String','-------------------------------- Event Operators --------------------------------','Position',[30,110,360,20]);
  
  PlotES_RaBut= uicontrol('Style','RadioButton','String','Event Spacing','Enable','off','Position',[30,90,90,20],'CallBack', @PlotES_RaBut_CallBack);
  PlotFI_RaBut= uicontrol('Style','RadioButton','String','Frequency Index','Enable','off','Position',[125,90,105,20],'CallBack', @PlotFI_RaBut_CallBack);
  PlotRMS_RaBut= uicontrol('Style','RadioButton','String','RMS','Enable','off','Position',[235,90,45,20],'CallBack', @PlotRMS_RaBut_CallBack);
  PlotPF_RaBut= uicontrol('Style','RadioButton','String','Peak Frequency','Enable','off','Position',[285,90,105,20],'CallBack', @PlotPF_RaBut_CallBack);
